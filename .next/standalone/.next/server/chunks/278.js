exports.id=278,exports.ids=[278,484],exports.modules={1484:(e,r,t)=>{"use strict";t(7329).config();let{Pool:o}=t(2449);e.exports=new o({connectionString:process.env.DATABASE_URL,ssl:{rejectUnauthorized:!1}})},6278:(e,r,t)=>{"use strict";let o=t(1484);e.exports={createOrder:async function(e,r){let t=await o.connect();try{await t.query("BEGIN");let o=0,a=[],n=r.map(e=>e.ean),s=`
      SELECT 
        p.ean, 
        p.name,
